...
int main()
{
	...
	while(1)
	{
		printf("1.add\t2.display\t3.count_nodes\t4.exit\n");
...
void count_nodes(struct st *ptr)
{
	struct st *temp=NULL;
	int cnt=0;
	if(ptr==NULL)
	...
	printf("count the nodesin cll =%d\n",cnt);
}
